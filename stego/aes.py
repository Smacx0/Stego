...
"""
    Code taken from https://github.com/ytdl-org/youtuble-dl/blob/master/youtube_dl/aes.py
"""
...
def aes_cbc_decrypt(data, key):
    ...
    return intlist_to_bytes(decrypted_data[BLOCK_SIZE_BYTES:])
...
def aes_cbc_encrypt(data, key):
    ...
    return intlist_to_bytes(iv) + intlist_to_bytes(encrypted_data)
